-- This migration ran before inventory tables were introduced in a later migration.
-- Keep it safe for shadow DB and fresh environments by no-oping unless tables exist.
DO $do$
BEGIN
